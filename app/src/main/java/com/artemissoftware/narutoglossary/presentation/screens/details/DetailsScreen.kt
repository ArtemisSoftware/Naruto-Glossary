...
import com.artemissoftware.narutoglossary.util.PalleteGenerator.convertImageUrlToBitmap
import com.artemissoftware.narutoglossary.util.PalleteGenerator.extractColorsFromBitmap
...
fun DetailsScreen(
    ...
    LaunchedEffect(key1 = true) {
        detailsViewModel.uiEvent.collectLatest { event ->
            when (event) {
                is DetailsUiEvent.GenerateColorPalette -> {
